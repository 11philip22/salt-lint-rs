...
#[cfg(test)]
mod tests {
    use super::sort_problems;
    use crate::problem::{Problem, Severity};

    #[test]
    fn sorts_by_filename_line_and_rule_id() {
        ...
        assert_eq!(problems[0].filename, "a.sls");
        assert_eq!(problems[0].id, "100");
        assert_eq!(problems[1].id, "200");
        assert_eq!(problems[2].filename, "b.sls");
    }
}
